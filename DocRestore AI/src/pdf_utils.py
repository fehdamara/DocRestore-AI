...
We use PyMuPDF because it is fast and practical for rendering PDF pages.
"""
...
# PIL is used to convert images into PDF files
from PIL import Image

# We import save_image from preprocessing to save RGB images properly
...
def images_to_pdf(image_paths, output_pdf_path):
    ...
    # This list will contain PIL image objects
    pil_images = []
    ...
    for image_path in image_paths:
        ...
        # Convert image to RGB because PDF saving requires RGB mode
        image = image.convert("RGB")

        # Add image to list
        pil_images.append(image)

    # The first image is used as the base PDF page
    first_image = pil_images[0]

    # The remaining images are appended as additional PDF pages
...
def save_restored_pdf(restored_images, output_dir, output_pdf_path):
    ...
    output_pdf_path = images_to_pdf(restored_image_paths, output_pdf_path)
