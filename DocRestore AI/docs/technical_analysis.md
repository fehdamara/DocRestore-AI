...
| Metric                  | Result                        |
| ----------------------- | ----------------------------- |
| Average PSNR            | TO BE FILLED AFTER EVALUATION |
| Average SSIM            | TO BE FILLED AFTER EVALUATION |
| FID Score               | TO BE FILLED AFTER EVALUATION |
| Average OCR Improvement | TO BE FILLED AFTER EVALUATION |

These values should be updated after the model is trained and evaluated.
